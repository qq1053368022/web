...
<head>
  ...
  <title>Login Form</title>
    ...
    <link rel="stylesheet" href="${request.contextPath}/css/normalize.min.css">
      <style>
      ...
      .inputStyle:focus { box-shadow: inset 0 -5px 45px rgba(100,100,100,0.4), 0 1px 1px rgba(255,255,255,0.2); }
      ...
      .inputStyle1:focus { box-shadow: inset 0 -5px 45px rgba(100,100,100,0.4), 0 1px 1px rgba(255,255,255,0.2); }
	  ...
	  .checkStyle:focus + label::before {
          box-shadow: 0 0 .1em .1em #58a;
      }
	  .checkStyle:disabled + label::before {
...
<body>
  ...
  <div class="login">
    ...
    <form action="" method="post">
		...
		<#if Request["jcaptchaEbabled"]>
			...
			<img class="jcaptcha-btn jcaptcha-img" src="${request.contextPath}/img/jcaptcha.jpg" title="点击更换验证码">
  ...
  <script src="${request.contextPath}/js/jquery-2.1.1.min.js"></script>
  <script>
      $(function() {
          $(".jcaptcha-btn").click(function() {
              $(".jcaptcha-img").attr("src", '${request.contextPath}/img/jcaptcha.jpg?'+new Date().getTime());
          });
      });
  </script>
